...
import { Code, Users, Briefcase, Download } from "lucide-react";
            ...
            <div className="absolute -bottom-6 -right-6 bg-slate-900/90 backdrop-blur-xl p-4 rounded-xl border border-white/10 shadow-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white font-bold">Intern</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex gap-4">
              <a
                ...
                download
                className="flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-medium hover:shadow-lg hover:shadow-cyan-500/25 transition-all"
              >
                <Download size={18} />
                Download CV
              </a>
